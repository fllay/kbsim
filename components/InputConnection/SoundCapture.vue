<template>
  ...
  >
    ...
    <div class="recorder-wrap" v-if="!recording">
...
export default {
  ...
  methods: {
    async draw(audioCtx, mediaStreamSource, time=3000, segment=250){
      ...
      for(let i=0;i<segment;i++){
        ...
        let actualHigh = v / 256 * h * 1.5 + 2;
        await this.$helper.sleep(time/segment);
        ctx.fillRect(i * w, (h - actualHigh) / 2,w, actualHigh);
      }
